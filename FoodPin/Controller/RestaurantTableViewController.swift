...
//        self.navigationItem.searchController = searchController
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let shareAction = UIContextualAction(style: .normal, title: NSLocalizedString("Share", comment: "Share")) { (action, sourceView, completionHandler) in
            let defaultText = NSLocalizedString("Just checking in at " + self.restaurants[indexPath.row].name!, comment: "Just checking in at " + self.restaurants[indexPath.row].name!)
    ...
    func prepareNotification() {
        ...
        content.body = "I recommend you to check out \(suggestedRestaurant.name!). The restaurant is one of your favorite. It is located at \(suggestedRestaurant.location!). Would you like to give it a try?"
...
extension RestaurantTableViewController: UIViewControllerPreviewingDelegate {
    func previewingContext(_ previewingContext: UIViewControllerPreviewing, viewControllerForLocation location: CGPoint) -> UIViewController? {
        ...
        guard let restaurantDetailViewController = storyboard?.instantiateViewController(withIdentifier: "ResturantDetailViewController") as? RestaurantDetailViewController else {
            return nil
        }
